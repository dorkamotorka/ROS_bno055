...
bool bno055::Bno055Driver::reset() {
    ...
    // reset
    i2c_smbus_write_byte_data(file_desc_, BNO055_SYS_TRIGGER, 0x20);
    usleep(250000);

    int i = 0;
    // wait for chip to come back online
    while(i2c_smbus_read_byte_data(file_desc_, BNO055_CHIP_ID) != BNO055_ID) {
    	usleep(1000);
        if(i++ > 500) {
    ...
    // normal power mode
    i2c_smbus_write_byte_data(file_desc_, BNO055_PWR_MODE, lastpwrmode);
    usleep(1000);

    i2c_smbus_write_byte_data(file_desc_, BNO055_PAGE_ID, 0);
    i2c_smbus_write_byte_data(file_desc_, BNO055_SYS_TRIGGER, 0);
    usleep(250000);

    i2c_smbus_write_byte_data(file_desc_, BNO055_OPR_MODE, lastopmode);
    usleep(250000);
...
bool bno055::Bno055Driver::setConfigMode() {
  ...
  if (getOprMode() != newmode) {
	  if (i2c_smbus_write_byte_data(file_desc_, BNO055_OPR_MODE, newmode) < 0)
	  {
...
bool bno055::Bno055Driver::getAcc() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_ACC_DATA_X_LSB, 0x06, (__u8*)&acc_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getMag() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_MAG_DATA_X_LSB, 0x06, (__u8*)&mag_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getGyr() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_GYR_DATA_X_LSB, 0x06, (__u8*)&gyr_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getEul() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_EUL_HEADING_LSB, 0x06, (__u8*)&eul_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getQua() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_QUA_DATA_W_LSB, 0x08, (__u8*)&qua_data) != 0x08)
  {
...
bool bno055::Bno055Driver::getLia() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_LIA_DATA_X_LSB, 0x06, (__u8*)&lia_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getGrv() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_GRV_DATA_X_LSB, 0x06, (__u8*)&grv_data) != 0x06)
  {
...
bool bno055::Bno055Driver::getTemp() {
  ...
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_TEMP, 0x01, (__u8*)&temp_data) != 0x01)
  {
...
bool bno055::Bno055Driver::getCalibStat() {
  calibStatData_t calib_stat_data;

  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_CALIB_STAT, 0x01, (__u8*)&calib_stat_data) != 0x01)
  {
...
bool bno055::Bno055Driver::getCalibOffset() {
  ...
  calibOffsetData_t calib_offset_data;

  // Read 18 bytes into offset data structure (6 bytes for acc, 6 bytes for mag, 6 bytes for gyr).
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_ACC_OFFSET_X_LSB, 0x12, (__u8*)&calib_offset_data) != 0x12)
  {
  ...
  if (i2c_smbus_write_byte_data(file_desc_, BNO055_OPR_MODE, lastmode) < 0)
  {
...
bool bno055::Bno055Driver::getCalibRadius() {
  ...
  calibRadiusData_t calib_radius_data;

  // Read 4 bytes into offset data structure (2 bytes for acc, 2 bytes for mag).
  if (i2c_smbus_read_i2c_block_data(file_desc_, BNO055_ACC_RADIUS_LSB, 0x04, (__u8*)&calib_radius_data) != 0x04)
  {
...
bool bno055::Bno055Driver::loadCalib() {
  ...
  i2c_smbus_write_i2c_block_data(file_desc_, BNO055_ACC_OFFSET_X_LSB, 0x06, (__u8*)&acc_offset[0]);
  i2c_smbus_write_i2c_block_data(file_desc_, BNO055_MAG_OFFSET_X_LSB, 0x06, (__u8*)&mag_offset[0]);
  i2c_smbus_write_i2c_block_data(file_desc_, BNO055_GYR_OFFSET_X_LSB, 0x06, (__u8*)&gyr_offset[0]);
  i2c_smbus_write_i2c_block_data(file_desc_, BNO055_ACC_RADIUS_LSB, 0x02, (__u8*)&acc_radius[0]);
  i2c_smbus_write_i2c_block_data(file_desc_, BNO055_MAG_RADIUS_LSB, 0x02, (__u8*)&mag_radius[0]);
